...
y_position = (screen_heigth - window_width)//2
window.geometry(f"{window_width}x{window_heigth}+{x_position}+{y_position}")
...
rock_button = tk.Button(window,text="ROCK",font=("Arial",14),command=lambda:play('rock')).pack(side="left",padx=10)
paper_button = tk.Button(window,text="PAPER",font=("Arial",14),command=lambda:play('paper')).pack(side="left",padx=10)
scissors_button = tk.Button(window,text="SCISSORS",font=("Arial",14),command=lambda:play('scissors')).pack(side="left",padx=10)
